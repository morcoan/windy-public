/* Harder known-source C for decompile scorecard quality comparison.
   ...
   Then re-export Ghidra (example):

     analyzeHeadless %TEMP%\\windy_ghidra_complex complex_proj ^
       -import complex.exe -deleteProject ^
       -postScript decompile_to_file.py complex_ghidra_output.json
