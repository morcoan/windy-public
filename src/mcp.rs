...
struct SetFunctionMemoryParams {
    ...
    /// 0â€“100; 0 means leave existing on merge.
    #[serde(default)]
    confidence: u8,
...
impl WindyMcp {
    ...
    // â”€â”€ Phase 7 MCP tools â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    #[tool(
        description = "What does each workspace member export? Returns api_name â†’ exporter list for the workspace."
    )]
    ...
    #[tool(
        description = "High-level cross-binary call graph JSON for a workspace (importâ†’export edges)."
    )]
    ...
    #[tool(
        description = "List symbol rename lineage (oldâ†’new) for a project. Pass va to filter one address; use va=0 or omit via 0x0 for all."
    )]
...
mod http_tests {
    ...
    fn streamable_http_release_contract_and_persistence() {
        let fixture =
            std::path::PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("tests/fixtures/sample.exe");
