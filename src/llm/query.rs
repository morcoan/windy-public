...
fn evidence_open_questions(
    ...
    if !project.function_memory.contains_key(&va) && apis.is_empty() && unknown_callees == 0 {
        // leaf-ish with no memory â€” still useful to note
        if q.is_empty() {
